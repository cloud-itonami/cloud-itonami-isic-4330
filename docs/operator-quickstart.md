# Operator Quickstart — Building Completion and Finishing

Shortest path from clone to a verified local dry-run for **ISIC 4330** (`cloud-itonami-isic-4330`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4330.git
cd cloud-itonami-isic-4330
```
...
- Blueprint governor key: `finishing-governor`
- Likely source path: `finishing.governor.cljc`
